...
public class PacketListenerManager {
    ...
    public void addListeners() {
        ...
        for (AbstractPacketListener listener : listeners) {
            try {
            	...
            	AnhyLingo2.warn("Unable to register listener " + listener.getClass().getSimpleName() + ":");
    ...
    public void removeListeners() {
        ProtocolLibrary.getProtocolManager().removePacketListeners(AnhyLingo2.getInstance());
    }
}
